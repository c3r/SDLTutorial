...
bool LTexture::loadFromFile(std::string path)
{
    ...
    SDL_SetColorKey(
        loadedSurface, SDL_TRUE, SDL_MapRGB(loadedSurface->format, 0, 0xFF, 0xFF));
...
bool LTexture::loadFromRenderedText(std::string textureText, SDL_Color textColor, TTF_Font* pFont)
{
    free();
    ...
    SDL_RendererFlip flip)
{
    ...
    SDL_RenderCopyEx(
        pRenderer, m_texture, clip, &renderQuad, angle, center, flip);
}
